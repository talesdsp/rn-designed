...
import * as expoTheme from "../constants/Themes";
import { mergeTheme, parseSpacing, spacing } from "../constants/Utils";
  ...
  getSpacings(type) {
    ...
    if (type === "margin") {
      return [
        ...
        marginVertical && parseSpacing("marginVertical", marginVertical, SIZES.base),
        marginHorizontal && parseSpacing("marginHorizontal", marginHorizontal, SIZES.base),
      ];
    }
    ...
    if (type === "padding") {
      return [
        ...
        paddingVertical && parseSpacing("paddingVertical", paddingVertical, SIZES.base),
        paddingHorizontal && parseSpacing("paddingHorizontal", paddingHorizontal, SIZES.base),
      ];
    }
  }
